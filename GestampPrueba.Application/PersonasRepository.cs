...
{
    public class PersonasRepository: GenericRepository<Personas3>, IPersonasRepository, IDisposable
    {
        private readonly masterContext context = null;

        public PersonasRepository(masterContext context) : base(context) { }
